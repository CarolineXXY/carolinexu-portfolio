        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <ul className="hidden md:flex items-center gap-8">
            ...
            <li>
              <Link
                href="#contact"
                className="px-5 py-2.5 bg-accent-wcag text-white text-sm font-medium rounded-lg hover:bg-accent transition-colors"
              >
                Get in Touch
              </Link>
            </li>
          ...
          <ul className="py-4 space-y-4 bg-card rounded-lg mb-4 shadow-lg">
            ...
            <li className="px-4">
              <Link
                href="#contact"
                onClick={() => setIsOpen(false)}
                className="block w-full text-center px-5 py-2.5 bg-accent-wcag text-white text-base font-medium rounded-lg hover:bg-accent transition-colors"
              >
                Get in Touch
              </Link>
            </li>
